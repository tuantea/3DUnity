...
public class OptionsUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            RebindBinding(GameInput.Binding.Gamepad_InteracAlternate);
        });
    ...
    private void UpdateVisual()
    {
        ...
        gamepadInteractAlternateText.text = GameInput.Instance.GetBindingText(GameInput.Binding.Gamepad_InteracAlternate);
